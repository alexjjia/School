...
void PrintInstructionList(FILE * outfile, Instruction * instr)
{
	...
	while(instr != NULL)
	{
//	printf("Iterating through print func\n");
//	printf("curr node's crit is at: %d\n", instr->critical);
//	printf("curr node's fields are: %d %d %d, with a crit of %d\n", instr->field1, instr->field2, instr->field3, instr->critical);
		if(instr->critical == 1) {
